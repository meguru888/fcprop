...
fcprop — AI-powered proposal builder for Singapore financial consultants: upload client info + benefit illustrations, get a personalized, story-driven, visually rich proposal in minutes.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "80609411+meguru888@users.noreply.github.com"
  git config user.name "meguru888"
  ```
